...
const AverageDownForm = () => {
  ...
  const onSubmit = (e) => {
    ...
    setBuyShares(buyShares)
    setBuyPrice(curPrice * buyShares)
  }
  ...
  return (
    <>
      ...
      <div className='results-display'>
        <p># of Shares To Buy: {buyShares}</p>
        <p>Cost to Buy Shares: ${buyPrice.toLocaleString('en')}</p>
      </div>
    </>
  )
}

export default AverageDownForm
